...
- [Collection Pipeline, Martin Fowler](https://martinfowler.com/articles/collection-pipeline/) - Contains catalog of general operations across languages, such as map, filter and reduce
